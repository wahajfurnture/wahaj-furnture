export async function getAllFabrics(query: string) {
  const response = await fetch(`/api/v1/admin/fabric?${query}`, {
    credentials: "include",
  });
...
export async function getFabricsByFurnId(furnId: string) {
  const response = await fetch(`/api/v1/admin/fabric/${furnId}`, {
    credentials: "include",
  });
...
export async function createFurniture(data: unknown) {
  const response = await fetch(`/api/v1/admin/furniture`, {
    method: "POST",
...
export async function createFabric(data: unknown) {
  const response = await fetch(`/api/v1/admin/fabric`, {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
...
export async function createColor(data: unknown) {
  const response = await fetch(`/api/v1/admin/color`, {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
...
export async function updateFurniture(furnId: string, data: unknown) {
  const response = await fetch(`/api/v1/admin/furniture/${furnId}`, {
    method: "PUT",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
...
export async function updateFabric({
  ...
  const response = await fetch(`/api/v1/admin/fabric/${fabricId}`, {
    method: "PUT",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
...
export async function updateColor(colorId: string, data: unknown) {
  const response = await fetch(`/api/v1/admin/color/${colorId}`, {
    credentials: "include",
    method: "PUT",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
...
export async function associateFabricWithFurniture(
  ...
  const response = await fetch(`/api/v1/admin/associate`, {
    credentials: "include",
